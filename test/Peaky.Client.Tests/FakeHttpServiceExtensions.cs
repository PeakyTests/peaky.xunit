...
{
    public static FakeHttpService.FakeHttpService WithTestResultAt(
        this FakeHttpService.FakeHttpService subject,
        string relativeUri,
        string content,
        bool passed)
    {
    ...
    public static FakeHttpService.FakeHttpService WithRetriableTestResultAt(
        this FakeHttpService.FakeHttpService subject,
        string relativeUri,
        string content,
        bool passed,
